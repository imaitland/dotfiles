...
local config = {
  cmd = {
	'java',
        ...
        '-jar', '/home/iainland/.local/opt/jdtls-launcher/jdtls/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
        -- '-configuration', '/Library/Java/jdt-language-server-1.5.0-202110191539/config_mac/',
        '-configuration', '/home/iainland/.local/opt/jdtls-launcher/jdtls/config_linux',
